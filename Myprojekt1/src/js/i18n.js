...
const interfaceTranslations = {
    ...
    brandShort: { ru: "Привоз", uk: "Привоз", en: "Pryvoz" },
    ...
    shop: { ru: "Лавка", uk: "Крамниця", en: "Shop" },
    newShop: { ru: "+ Новая лавка", uk: "+ Нова крамниця", en: "+ New shop" },
    homeKicker: { ru: "Одесса · рынок Привоз", uk: "Одеса · ринок Привоз", en: "Odesa · Pryvoz Market" },
    ...
    goShop: { ru: "В лавку", uk: "До крамниці", en: "Visit shop" },
    myShop: { ru: "Моя лавка", uk: "Моя крамниця", en: "My shop" },
    openShop: { ru: "Открыть лавку", uk: "Відкрити крамницю", en: "Open shop" },
    editShop: { ru: "Редактировать лавку", uk: "Редагувати крамницю", en: "Edit shop" },
    ...
    createShop: { ru: "Создать новую лавку", uk: "Створити нову крамницю", en: "Create a new shop" },
    chooseShop: { ru: "Выберите лавку для редактирования", uk: "Оберіть крамницю для редагування", en: "Choose a shop to edit" },
    ...
    shopName: { ru: "Название лавки", uk: "Назва крамниці", en: "Shop name" },
    shortDescription: { ru: "Краткое описание", uk: "Короткий опис", en: "Short description" },
    createShopButton: { ru: "Создать лавку", uk: "Створити крамницю", en: "Create shop" },
    createShopFailed: { ru: "Не удалось создать лавку", uk: "Не вдалося створити крамницю", en: "Could not create shop" },
    shopCreated: { ru: "Лавка создана.", uk: "Крамницю створено.", en: "Shop created." },
    enterShopName: { ru: "Введите название лавки.", uk: "Введіть назву крамниці.", en: "Enter shop name." },
    saving: { ru: "Сохраняем...", uk: "Зберігаємо...", en: "Saving..." },
    checkingAuthAndSavingShop: { ru: "Проверяем вход и сохраняем лавку...", uk: "Перевіряємо вхід і зберігаємо крамницю...", en: "Checking sign-in and saving shop..." },
    ...
    accountAlreadyHasShop: { ru: "У этого аккаунта уже есть лавка. Откройте её для управления.", uk: "У цього акаунта вже є крамниця. Відкрийте її для керування.", en: "This account already has a shop. Open it to manage it." },
    accountAlreadyHasShopOpening: { ru: "У этого аккаунта уже есть лавка. Открываю редактирование.", uk: "У цього акаунта вже є крамниця. Відкриваю редагування.", en: "This account already has a shop. Opening editing." },
    newShopUnavailable: { ru: "Новая лавка недоступна: один аккаунт управляет одной лавкой.", uk: "Нова крамниця недоступна: один акаунт керує однією крамницею.", en: "New shop is unavailable: one account manages one shop." },
    noActiveShopCreateAbove: { ru: "У этого аккаунта нет активной лавки. Можно создать новую выше.", uk: "У цього акаунта немає активної крамниці. Можна створити нову вище.", en: "This account has no active shop. You can create a new one above." },
    shopNotFoundCreateHint: { ru: "Лавка для этого аккаунта пока не найдена. Нажмите «+ Новая лавка», если хотите создать её.", uk: "Крамницю для цього акаунта поки не знайдено. Натисніть «+ Нова крамниця», якщо хочете її створити.", en: "No shop was found for this account yet. Press '+ New shop' if you want to create it." },
    databaseUnavailableTitle: { ru: "База не подключилась. Создание лавки временно недоступно.", uk: "База не підключилася. Створення крамниці тимчасово недоступне.", en: "Database did not connect. Shop creation is temporarily unavailable." },
    databaseUnavailableMessage: { ru: "Обновите страницу или проверьте интернет. Без Supabase лавка не создаётся.", uk: "Оновіть сторінку або перевірте інтернет. Без Supabase крамниця не створюється.", en: "Refresh the page or check the internet. A shop cannot be created without Supabase." },
